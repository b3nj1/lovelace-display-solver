 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function pe(e){return function(e){return(t,i)=>"object"==typeof i?de(e,t,i):((e,t,i)=>{const s=t.hasOwnProperty(i);return t.constructor.createProperty(i,e),s?Object.getOwnPropertyDescriptor(t,i):void 0})(e,t,i)}({...e,state:!0,attribute:!1})}function ue(e){const[t,i]=e.split(":").map(Number);return 60*t+i}function fe(e,t,i,s){if(void 0!==e.state&&t!==e.state)return!1;if(void 0!==e.range){const i=parseFloat(t);if(isNaN(i))return!1;const[s,o]=e.range;if(null!==s&&i<s)return!1;if(null!==o&&i>o)return!1}if(void 0!==e.above){const i=parseFloat(t);if(isNaN(i)||i<=e.above)return!1}if(void 0!==e.time_range){const[t,i]=e.time_range;if(!function(e,t,i){const s=60*i.getHours()+i.getMinutes(),o=ue(e),n=ue(t);return o<=n?s>=o&&s<=n:s>=o||s<=n}(t,i,s))return!1}if(void 0!==e.also)for(const t of e.also){const e=i[t.entity];if(!e||e.state!==t.state)return!1}return!0}function _e(e,t,i,s,o=new Date){if(0===i.length)return null;const n=t[e.entity_id],r=n?.state;if(!n||"unavailable"===r||"unknown"===r){const t=e.rules?.some(e=>"unavailable"===e.when.state||"unknown"===e.when.state)??!1;if(!t){if(!s.unavailable_action||"hide"===s.unavailable_action)return null;const t="entity"===e.glyph?n?.attributes?.icon??"":e.glyph??"";return{entityConfig:e,tier:i[i.length-1],color:"",glyphName:t,showInfo:s.show_info??!1,focusMode:!1,indicatorOnly:!1,driveZoneIndicator:!1}}}const a=r??"",l="entity"===e.glyph?n?.attributes?.icon??"":e.glyph??"";return e.rules?function(e,t,i,s,o,n,r){if(!e.rules)return null;for(const a of e.rules){if(!fe(a.when,t,i,r))continue;const l=a.then;return"hide"===l.action?null:{entityConfig:e,tier:l.tier??s[0],color:l.color??"",glyphName:o,showInfo:l.show_info??n.show_info??!1,focusMode:l.focus_mode??!1,indicatorOnly:"indicator"===l.action,driveZoneIndicator:"show"===l.action&&!0===l.indicator}}return null}(e,a,t,i,l,s,o):e.thresholds?function(e,t,i,s,o){if(!e.thresholds)return null;const n=parseFloat(t);if(isNaN(n))return null;const r=e.color_scale??o.color_scale??[];let a=null,l=-1;for(let t=0;t<e.thresholds.length;t++){const i=e.thresholds[t];n>i.above&&(a=i,l=t)}if(!a)return null;const c=a.color??(l<r.length?r[l]:"");return{entityConfig:e,tier:a.tier??i[0],color:c,glyphName:s,showInfo:o.show_info??!1,focusMode:!1,indicatorOnly:!1,driveZoneIndicator:!1}}(e,a,i,l,s):null}const ge={red:{r:255,g:0,b:0},orange:{r:255,g:165,b:0},yellow:{r:255,g:255,b:0},green:{r:0,g:255,b:0},blue:{r:0,g:0,b:255},purple:{r:128,g:0,b:128},white:{r:255,g:255,b:255},cyan:{r:0,g:255,b:255},magenta:{r:255,g:0,b:255},black:{r:0,g:0,b:0}},me=new Set;function ye(e){const t=ge[e];return void 0!==t?t:(me.has(e)||(me.add(e),console.warn(`resolveColor: unknown color "${e}" — valid values are: red, orange, yellow, green, blue, purple, white, cyan, magenta, black`)),{r:255,g:255,b:255})}const ve={far:{max_size:"large",max_info_rows:0,prefer_fewer_icons:!0},near:{max_size:"medium",max_info_rows:4,prefer_fewer_icons:!1},close:{max_size:"tiny",max_info_rows:6,prefer_fewer_icons:!1}};function be(e,t,i){const s=function(e){const t=ve[e.viewing_distance];return void 0===t?(console.warn(`expandViewingDistance: unknown viewing_distance "${e.viewing_distance}" — falling back to "near"`),ve.near):t}(e),o=Object.keys(e.glyph_sizes),n=o.indexOf(s.max_size);for(const r of e.layouts){if(-1!==n){const e=o.indexOf(r.icon.size);if(-1===e||e<n)continue}if(!(t<r.icon.min||t>r.icon.max)&&((i||!(r.info.min>0))&&!(0===s.max_info_rows&&r.info.min>0)))return r}return null}function $e(e,t){if(e.burn_in_drift){return{xOffset:Math.floor(t.getHours()/23*e.margin_px[0]),yOffset:Math.floor(t.getMinutes()/59*e.margin_px[1])}}return{xOffset:0,yOffset:0}}function we(e,t){const i=t.margin_px[0]/t.screen_px[0],s=t.margin_px[1]/t.screen_px[1];if("object"==typeof e)return e;switch(e){case"top-edge":return{x:0,y:0,w:1,h:s};case"bottom-edge":return{x:0,y:1-s,w:1,h:s};case"left-edge":return{x:0,y:0,w:i,h:1};case"right-edge":return{x:1-i,y:0,w:i,h:1};case"top-left":return{x:0,y:0,w:i,h:s};case"top-right":return{x:1-i,y:0,w:i,h:s};case"bottom-left":return{x:0,y:1-s,w:i,h:s};case"bottom-right":return{x:1-i,y:1-s,w:i,h:s}}}function xe(e,t){return{x:Math.floor(e.x*t.screen_px[0]),y:Math.floor(e.y*t.screen_px[1]),w:Math.round(e.w*t.screen_px[0]),h:Math.round(e.h*t.screen_px[1])}}function Ae(e,t){return function(e,t){const i=t[e.entity_id],s=i?.state??"",o=i?.attributes?.unit_of_measurement??"",n=(e.value_format??"{value} {unit}").replace(/\{value:\.0f\}/g,()=>{const e=parseFloat(s);return isNaN(e)?s:Math.round(e).toString()}).replace(/\{value\}/g,s).replace(/\{unit\}/g,o),r=e.label??i?.attributes?.friendly_name??e.id;return`${n.trim()} ${r}`.trimEnd()}(e,t)}function Se(e,t,i,s){const o=Object.keys(e.glyph_sizes).reduce((t,i)=>{const s=e.glyph_sizes[i].px;return s>t?s:t},0),n=Math.floor((e.screen_px[0]-o)/2),r=Math.floor((e.screen_px[1]-o)/2),a=t(e.idle_glyph),{r:l,g:c,b:h}=ye("white");return{codepoint:a,x:n,y:r,sizePx:o,r:l,g:c,b:h}}function Ee(e,t,i,s,o,n,r,a,l){const c=[],h=new Date,d=[];for(const o of e){const e=_e(o,t,i,s,h);null!==e&&d.push(e);const n=Array.isArray(o.rules)&&o.rules.length>0,r=Array.isArray(o.thresholds)&&o.thresholds.length>0;n||r||c.push(`Entity '${o.id}' has no rules or thresholds and will never be active.`)}d.sort((e,t)=>i.indexOf(e.tier)-i.indexOf(t.tier));const p=function(e,t){return e.some(e=>e.focusMode)?e.filter(e=>e.tier===t[0]):e}(d,i),u=new Map;for(const e of p)if(!u.has(e.glyphName)){const t=r(e.glyphName);if(u.set(e.glyphName,t),n.font_glyphs&&n.font_glyphs.length>0){const t=e.glyphName;n.font_glyphs.includes(t)||c.push(`Glyph '${t}' not in profile '${n.id}' font_glyphs — will render blank. Add '${t}' to the glyphs: list in your ESPHome device YAML and recompile.`)}}const f=new Map(o.map(e=>[e.id,e])),_=p.filter(e=>!e.indicatorOnly),g=new Map;for(const e of _){const t=e.entityConfig.group;if(void 0!==t){const i=f.get(t);i&&"overlay"===i.collapse&&!g.has(t)&&g.set(t,e)}}const m=new Set;let y=0;for(const e of _){const t=e.entityConfig.group;if(void 0!==t){const e=f.get(t);if(e&&"overlay"===e.collapse){m.has(t)||(m.add(t),y+=1);continue}}y+=1}const v=y,b=p.some(e=>e.showInfo),$=be(n,v,b);if(null===$){const e=Object.keys(n.glyph_sizes),t={icon:{min:0,max:0,size:e[e.length-1]??"medium",cols:1},info:{min:0,max:0}};return{profile_id:n.id,glyphs:[],info:[],zones:[],severity_bar:null,layout:t,error:!0,errorReason:`No layout matches: icon_count=${v}, hasInfo=${b}. Check your profile's layouts table.`,warnings:c,page_count:1}}const w=Math.ceil(v/$.icon.max)||1,x=Math.min(a,w-1),A=[],S=new Set;for(const e of _){const t=e.entityConfig.group;if(void 0!==t){const e=f.get(t);if(e&&"overlay"===e.collapse){S.has(t)||(S.add(t),A.push(g.get(t)));continue}}A.push(e)}const E=x*$.icon.max,k=E+$.icon.max,P=A.slice(E,k),M=function(e,t,i){const s=new Date,{xOffset:o,yOffset:n}=$e(e,s),r=e.margin_px[0]+o,a=e.margin_px[1]+n,l=e.glyph_sizes[t.icon.size];if(void 0===l)throw new Error(`layout.icon.size "${t.icon.size}" is not defined in profile "${e.id}" glyph_sizes`);const c=l.px,h=i.filter(e=>!e.indicatorOnly);return h.map((e,i)=>{const s=i%t.icon.cols,o=Math.floor(i/t.icon.cols),n=Math.floor(r+s*c),l=Math.floor(a+o*c),{r:h,g:d,b:p}=ye(e.color);return{codepoint:"",x:n,y:l,sizePx:c,r:h,g:d,b:p}})}(n,$,P),C=M.map((e,t)=>({...e,codepoint:u.get(P[t].glyphName)??""})),O=p.filter(e=>e.showInfo),z=function(e,t,i){const s=new Date,{xOffset:o,yOffset:n}=$e(e,s),r=e.glyph_sizes[t.icon.size];if(void 0===r)throw new Error(`layout.icon.size "${t.icon.size}" is not defined in profile "${e.id}" glyph_sizes`);const a=r.px,l=Math.ceil(i/t.icon.cols)*a;return{x:Math.floor(e.margin_px[0]+o),y:Math.floor(e.margin_px[1]+n+l),lineHeight:12}}(n,$,v),N=O.map((e,i)=>{const s=Ae(e.entityConfig,t),{r:o,g:n,b:r}=ye(e.color);return{text:s,x:z.x,y:z.y+i*z.lineHeight,r:o,g:n,b:r}}),{xOffset:R,yOffset:T}=$e(n,h),H=function(e,t){const i=[];for(const s of e.zones??[]){const o=t.find(e=>e.entityConfig.zone===s.id&&(!0===e.indicatorOnly||!0===e.driveZoneIndicator));if(!o)continue;const n=xe(we(s.position,e),e),{r,g:a,b:l}=ye(o.color);i.push({zoneId:s.id,x:n.x,y:n.y,w:n.w,h:n.h,r,g:a,b:l,shape:"filled_rectangle"})}return i}(n,p),U=function(e,t,i){const s=e.severity_bar;if(!s)return null;const[o,n]=e.screen_px,[r,a]=e.margin_px,l=new Date,{xOffset:c,yOffset:h}=$e(e,l);let d,p;if(0===t.length){if(!1!==s.hide_when_idle)return null;d=0,p="entity"===s.color?{r:255,g:255,b:255}:ye(s.color)}else{const e=i.length,o=t[0].tier;d=(e-i.indexOf(o))/e,p="entity"===s.color?ye(t[0].color):ye(s.color)}const u=s.thickness_px,f=s.edge;let _,g,m,y;return"bottom"===f?(m=Math.round(d*(o-2*r)),y=u,_=r+c,g=n-a-u+h):"top"===f?(m=Math.round(d*(o-2*r)),y=u,_=r+c,g=a+h):"left"===f?(m=u,y=Math.round(d*(n-2*a)),_=r+c,g=a+h):(m=u,y=Math.round(d*(n-2*a)),_=o-r-u+c,g=a+h),{x:_,y:g,w:m,h:y,r:p.r,g:p.g,b:p.b}}(n,p,i),I=0===p.length?[Se(n,r)]:C;return{profile_id:n.id,glyphs:I,info:N,zones:H,severity_bar:U,layout:$,error:!1,warnings:c,page_count:w}}function ke(e,t){const i=[],s=[],o=[],n=[],r=[],a=[];for(let t=0;t<e.glyphs.length;t++){const l=e.glyphs[t];if(i.push(l.x),s.push(l.y),o.push(l.r),n.push(l.g),r.push(l.b),a.push(l.codepoint),i.length!==t+1||s.length!==t+1||o.length!==t+1||n.length!==t+1||r.length!==t+1||a.length!==t+1)throw new Error(`Glyph array length mismatch at index ${t}`)}const l=function(e,t){const i=Object.entries(e.glyph_sizes).sort((e,t)=>t[1].px-e[1].px).map(([e])=>e),s=i.indexOf(t);return-1===s?(console.warn(`glyphFontIndex: size name "${t}" not found in profile "${e.id}"; defaulting to index 0`),0):s}(t,e.layout.icon.size),c=[],h=[],d=[],p=[],u=[],f=[],_=[],g=[],m=[],y=[],v=[],b=[];for(let t=0;t<e.info.length;t++){const i=e.info[t];if(c.push(0),h.push(i.x),d.push(i.y),p.push(i.r),u.push(i.g),f.push(i.b),c.length!==t+1||h.length!==t+1||d.length!==t+1||p.length!==t+1||u.length!==t+1||f.length!==t+1)throw new Error(`Info glyph array length mismatch at index ${t}`);if(_.push(i.text),g.push(i.x),m.push(i.y),y.push(i.r),v.push(i.g),b.push(i.b),_.length!==t+1||g.length!==t+1||m.length!==t+1||y.length!==t+1||v.length!==t+1||b.length!==t+1)throw new Error(`Info text array length mismatch at index ${t}`)}const $=e.info.length>e.layout.info.max,w={filled_rectangle:0,circle:1,filled_circle:2},x=[],A=[],S=[],E=[],k=[],P=[],M=[],C=[];for(let t=0;t<e.zones.length;t++){const i=e.zones[t],s=w[i.shape];if(void 0===s&&console.warn(`packESPhomePayload: unknown shape '${i.shape}' for zone '${i.zoneId}' — defaulting to 0 (filled_rectangle)`),x.push(s??0),A.push(i.x),S.push(i.y),E.push(i.w),k.push(i.h),P.push(i.r),M.push(i.g),C.push(i.b),x.length!==t+1||A.length!==t+1||S.length!==t+1||E.length!==t+1||k.length!==t+1||P.length!==t+1||M.length!==t+1||C.length!==t+1)throw new Error(`Shape array length mismatch at index ${t}`)}if(null!==e.severity_bar){const t=e.severity_bar,i=x.length;if(x.push(0),A.push(t.x),S.push(t.y),E.push(t.w),k.push(t.h),P.push(t.r),M.push(t.g),C.push(t.b),x.length!==i+1||A.length!==i+1||S.length!==i+1||E.length!==i+1||k.length!==i+1||P.length!==i+1||M.length!==i+1||C.length!==i+1)throw new Error(`Shape array length mismatch at severity_bar index ${i}`)}return{x:i,y:s,r:o,g:n,b:r,glyph:a,glyph_font:l,info_glyph:c,info_glyph_y:d,info_glyph_x:h,info_glyph_r:p,info_glyph_g:u,info_glyph_b:f,info_text:_,info_text_y:m,info_text_x:g,info_text_r:y,info_text_g:v,info_text_b:b,info_scroll:$,draw_shape:x,draw_shape_x:A,draw_shape_y:S,draw_shape_d2:E,draw_shape_d3:k,draw_shape_r:P,draw_shape_g:M,draw_shape_b:C,error:e.error}}const Pe="?",Me={"mdi:molecule-co2":"co2","mdi:pool":"pool","mdi:thermometer":"thermostat","mdi:water":"water_drop","mdi:car-electric":"electric_car","mdi:fan":"mode_fan","mdi:lightbulb":"lightbulb","mdi:lock":"lock","mdi:door":"door_open","mdi:garage":"garage","mdi:security":"security","mdi:air-filter":"air","mdi:factory":"factory","mdi:grill":"outdoor_grill","mdi:thermometer-auto":"device_thermostat","mdi:arrow-up":"arrow_upward","mdi:arrow-down":"arrow_downward","mdi:check-circle":"check_circle","mdi:chef-hat":"kitchen","mdi:smoke-detector":"detector_smoke","mdi:motion-sensor":"motion_sensor_active","mdi:window-open":"window","mdi:door-open":"door_open","mdi:fire":"local_fire_department","mdi:alarm":"alarm","mdi:bell":"notifications","mdi:home":"home","mdi:weather-sunny":"sunny","mdi:weather-rainy":"rainy","mdi:weather-snowy":"ac_unit","mdi:weather-cloudy":"cloud","mdi:weather-windy":"air","mdi:lightning-bolt":"bolt","mdi:power-plug":"power","mdi:battery":"battery_full","mdi:battery-low":"battery_1_bar","mdi:wifi":"wifi","mdi:wifi-off":"wifi_off","mdi:bluetooth":"bluetooth","mdi:volume-high":"volume_up","mdi:volume-off":"volume_off","mdi:play":"play_arrow","mdi:pause":"pause","mdi:stop":"stop","mdi:camera":"camera_alt","mdi:video":"videocam","mdi:microphone":"mic","mdi:speaker":"speaker","mdi:television":"tv","mdi:phone":"call","mdi:message":"message","mdi:email":"email","mdi:calendar":"calendar_today","mdi:clock":"schedule","mdi:map-marker":"location_on","mdi:car":"directions_car","mdi:bus":"directions_bus","mdi:train":"train","mdi:walk":"directions_walk","mdi:run":"directions_run","mdi:bicycle":"directions_bike","mdi:alert":"warning","mdi:alert-circle":"error","mdi:information":"info","mdi:help-circle":"help","mdi:star":"star","mdi:heart":"favorite","mdi:trash-can":"delete","mdi:pencil":"edit","mdi:magnify":"search","mdi:close":"close","mdi:plus":"add","mdi:minus":"remove","mdi:refresh":"refresh","mdi:download":"download","mdi:upload":"upload","mdi:share":"share","mdi:cog":"settings","mdi:account":"person","mdi:account-group":"group","mdi:shield":"shield","mdi:key":"key","mdi:window":"window","mdi:power":"power_settings_new","mdi:shield-lock":"lock","mdi:shield-home":"home","mdi:lightbulb-on":"lightbulb"},Ce={garage:"",door_open:"",lock:"",security:"",co2:"",air:"",factory:"",mode_fan_off:"",mode_fan:"",power_settings_new:"",thermostat:"",water_drop:"",outdoor_grill:"",pool:"",device_thermostat:"",lightbulb:"",arrow_upward:"",arrow_downward:"",check_circle:"",kitchen:"",electric_car:"",detector_smoke:"",motion_sensor_active:"",window:"",local_fire_department:"",alarm:"",notifications:"",home:"",sunny:"",rainy:"",ac_unit:"",cloud:"",bolt:"",power:"",battery_full:"",battery_1_bar:"",wifi:"",wifi_off:"",bluetooth:"",volume_up:"",volume_off:"",play_arrow:"",pause:"",stop:"",camera_alt:"",videocam:"",mic:"",speaker:"",tv:"",call:"",message:"",email:"",calendar_today:"",schedule:"",location_on:"",directions_car:"",directions_bus:"",train:"",directions_walk:"",directions_run:"",directions_bike:"",warning:"",error:"",info:"",help:"",star:"",favorite:"",delete:"",edit:"",search:"",close:"",add:"",remove:"",refresh:"",download:"",upload:"",share:"",settings:"",person:"",group:"",shield:"",key:""};function Oe(e){if(0===e.length)return Pe;if("entity"===e)throw new Error('resolveGlyph: "entity" must be resolved to a concrete name before calling resolveGlyph');if(e.startsWith("mdi:")){const t=Me[e];if(void 0===t)return console.warn(`resolveGlyph: no MDI→MSS mapping for "${e}" — add the icon to MDI_TO_MSS or use a Material Symbols Sharp name directly`),Pe;const i=Ce[t];return i||(console.warn(`resolveGlyph: MDI "${e}" maps to MSS "${t}" but "${t}" is not in MSS_CODEPOINTS — add "${t}" to your ESPHome firmware's font_glyphs list`),Pe)}if(1===e.length){const t=e.codePointAt(0);if(void 0!==t&&t>127)return e}if(2===e.length){const t=e.codePointAt(0);if(void 0!==t&&t>65535)return e}const t=Ce[e];return t||(console.warn(`resolveGlyph: glyph "${e}" not found in MSS_CODEPOINTS — add "${e}" to your ESPHome firmware's font_glyphs list`),Pe)}const ze=new Set;async function Ne(e,t,i){i.width=t.screen_px[0],i.height=t.screen_px[1];const s=i.getContext("2d");null!==s&&(s.fillStyle="#000",s.fillRect(0,0,i.width,i.height),await async function(e){if("undefined"!=typeof document&&document.fonts)for(const[,t]of Object.entries(e)){const e=t.px,i="Material Symbols Sharp",s=`${i}:${e}`;if(ze.has(s))continue;const o=`mss-font-${e}`;if(!document.getElementById(o)&&document.head){const t=document.createElement("link");t.id=o,t.rel="stylesheet",t.href=`https://fonts.googleapis.com/css2?family=Material+Symbols+Sharp:opsz,wght,FILL,GRAD@${e},400,0,0`,document.head.appendChild(t)}await document.fonts.load(`${e}px '${i}'`),ze.add(s)}}(t.glyph_sizes),function(e,t){for(const i of t){const t=i.codepoint===Pe?"Material Design Icons":"Material Symbols Sharp";e.font=`${i.sizePx}px '${t}'`,e.fillStyle=`rgb(${i.r}, ${i.g}, ${i.b})`,e.fillText(i.codepoint,i.x,i.y+i.sizePx)}}(s,e.glyphs),function(e,t){for(const i of t)e.font="12px monospace",e.fillStyle=`rgb(${i.r}, ${i.g}, ${i.b})`,e.fillText(i.text,i.x,i.y)}(s,e.info),function(e,t){for(const i of t)"filled_rectangle"===i.shape?(e.fillStyle=`rgb(${i.r},${i.g},${i.b})`,e.fillRect(i.x,i.y,i.w,i.h)):"filled_circle"===i.shape?(e.fillStyle=`rgb(${i.r},${i.g},${i.b})`,e.beginPath(),e.arc(i.x+i.w/2,i.y+i.h/2,i.w/2,0,2*Math.PI),e.fill()):"circle"===i.shape&&(e.strokeStyle=`rgb(${i.r},${i.g},${i.b})`,e.beginPath(),e.arc(i.x+i.w/2,i.y+i.h/2,i.w/2,0,2*Math.PI),e.stroke())}(s,e.zones),function(e,t,i){if(null!==t)return e.fillStyle=`rgb(${t.r}, ${t.g}, ${t.b})`,void e.fillRect(t.x,t.y,t.w,t.h);if(!1===i.severity_bar?.hide_when_idle){e.strokeStyle="#555555";const t=i.margin_px,s=i.screen_px,o=i.severity_bar.thickness_px;e.strokeRect(t[0],s[1]-t[1]-o,s[0]-2*t[0],o)}}(s,e.severity_bar,t))}let Re=class extends ae{constructor(){super(...arguments),this._errors=[],this._results=new Map,this._pageState={}}setConfig(e){const t=function(e){const t=[];if("object"!=typeof e||null===e)t.push("config must be an object");else{const i=e,s=i.tiers,o=new Set;if(Array.isArray(s)&&0!==s.length)for(let e=0;e<s.length;e++)"string"!=typeof s[e]?t.push(`tiers[${e}] must be a string`):o.add(s[e]);else t.push("tiers must be a non-empty array");const n=i.entities;if(Array.isArray(n)&&0!==n.length){const e=new Set,s=i.groups;if(Array.isArray(s))for(const t of s)if("object"==typeof t&&null!==t){const i=t.id;"string"==typeof i&&e.add(i)}for(let i=0;i<n.length;i++){const s=n[i];if("object"!=typeof s||null===s){t.push(`entities[${i}] must be an object`);continue}const r=s;"string"==typeof r.id&&0!==r.id.length||t.push(`entities[${i}].id is required`),"string"==typeof r.entity_id&&0!==r.entity_id.length||t.push(`entities[${i}].entity_id is required`);const a=Array.isArray(r.rules),l=Array.isArray(r.thresholds);if(a&&l&&t.push(`entities[${i}] (id=${String(r.id)}) must not have both rules and thresholds`),a){const e=r.rules;for(let s=0;s<e.length;s++){const n=e[s];if("object"!=typeof n||null===n)continue;const r=n.then;if("object"==typeof r&&null!==r){const e=r.tier;void 0===e||"string"!=typeof e||o.has(e)||t.push(`entities[${i}].rules[${s}].then.tier "${e}" is not declared in tiers`)}}}if(l){const e=r.thresholds;let s=null;for(let n=0;n<e.length;n++){const r=e[n];if("object"!=typeof r||null===r)continue;const a=r,l=a.tier;void 0===l||"string"!=typeof l||o.has(l)||t.push(`entities[${i}].thresholds[${n}].tier "${l}" is not declared in tiers`);const c=a.above;"number"==typeof c&&(null!==s&&c<=s&&t.push(`entities[${i}].thresholds[${n}].above (${c}) must be strictly greater than previous (${s})`),s=c)}}"string"!=typeof r.group||e.has(r.group)||t.push(`entities[${i}].group "${String(r.group)}" references undeclared group`)}}else t.push("entities must be a non-empty array");const r=i.display_profiles;if(Array.isArray(r)&&0!==r.length)for(let e=0;e<r.length;e++){const i=r[e];if("object"!=typeof i||null===i){t.push(`display_profiles[${e}] must be an object`);continue}const s=i;"string"==typeof s.id&&0!==s.id.length||t.push(`display_profiles[${e}].id is required`);const o=new Set(["esphome","canvas","cast","png_file"]);"string"==typeof s.type&&o.has(s.type)||t.push(`display_profiles[${e}].type must be one of: esphome, canvas, cast, png_file`);const n=s.screen_px;if(Array.isArray(s.screen_px)&&2===s.screen_px.length&&"number"==typeof n[0]&&"number"==typeof n[1]||t.push(`display_profiles[${e}].screen_px must be a [width, height] tuple of numbers`),"esphome"===s.type&&("string"!=typeof s.service||0===s.service.length)){const i="string"==typeof s.id?` (id=${s.id})`:"";t.push(`display_profiles[${e}]${i} (type=esphome) must have a service field`)}}else t.push("display_profiles must be a non-empty array");const a=i.groups;if(Array.isArray(a)){const e=new Set;for(let i=0;i<a.length;i++){const s=a[i];if("object"!=typeof s||null===s)continue;const o=s.id;"string"==typeof o&&(e.has(o)&&t.push(`groups id "${o}" is not unique`),e.add(o))}}}return t}(e);t.length>0?this._errors=t:(this._config=structuredClone(e),this._errors=[])}set hass(e){this._hass=e;for(const e of Object.keys(this._pageState))clearTimeout(this._pageState[e].dwellTimer);this._runSolver()}get hass(){return this._hass}_runSolver(){if(this._config&&this._hass)for(const e of this._config.display_profiles){this._pageState[e.id]??={currentPage:0};const t=this._pageState[e.id],i=Ee(this._config.entities,this._hass.states,this._config.tiers,this._config.defaults??{},this._config.groups??[],e,Oe,t.currentPage);if(this._results.set(e.id,i),"canvas"===e.type)this.requestUpdate();else if("esphome"===e.type&&!i.error){const t=e.service.split("."),s=t[0],o=t.slice(1).join("."),n=ke(i,e);this._hass.callService(s,o,n).catch(e=>{console.error("display-solver: callService failed",e)})}if(i.page_count>1){const s=1e3*(e.page_dwell_s??5);t.dwellTimer=setTimeout(()=>{const t=this._pageState[e.id];t&&(t.currentPage=(t.currentPage+1)%i.page_count,this._runSolver())},s)}}}updated(e){if(super.updated(e),this._config)for(const e of this._config.display_profiles){if("canvas"!==e.type)continue;const t=this._results.get(e.id);if(!t)continue;const i=this.shadowRoot?.querySelector(`#canvas-${e.id}`);i&&Ne(t,e,i).catch(e=>{console.error("display-solver: renderToCanvas failed",e)})}}disconnectedCallback(){super.disconnectedCallback();for(const e of Object.keys(this._pageState))clearTimeout(this._pageState[e].dwellTimer)}render(){if(this._errors.length>0)return B`<ha-card>
        <div class="error">
  ...
  `}};e([pe()],Re.prototype,"_config",void 0),e([pe()],Re.prototype,"_hass",void 0),e([pe()],Re.prototype,"_errors",void 0),Re=e([ce("display-solver-card")],Re),window.customCards=window.customCards||[],window.customCards.push({type:"display-solver-card",name:"Display Solver",description:"Priority dashboard for ESPHome and Chromecast displays",preview:!0,documentationURL:"https://github.com/b3nj1/lovelace-display-solver"});let Te=class extends ae{constructor(){super(...arguments),this._expandedEntity=null}setConfig(e){this._config=e}set hass(e){this._hass=e}_dispatch(e){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}render(){return this._config?B`
      <div class="editor">
    ...
    `}_renderEntityRow(e,t){return B`
      <div class="entity-row">
        ...
        ${this._hass?B`<ha-entity-picker
              ...
              label="Entity"
              allow-custom-entity
              @value-changed=${i=>this._updateEntity(t,{...e,entity_id:i.detail.value})}
        ...
        ${s.map((e,o)=>B`
          <div class="rule-row">
            ...
            <ha-select
              label="Action"
              .value=${e.then.action}
              @selected=${i=>{const n={...e,then:{...e.then,action:i.detail.value}};this._updateEntityRules(t,s.map((e,t)=>t===o?n:e))}}
            >
            ...
            <ha-select
              label="Tier"
              .value=${e.then.tier??""}
              @selected=${i=>{const n={...e,then:{...e.then,tier:i.detail.value||void 0}};this._updateEntityRules(t,s.map((e,t)=>t===o?n:e))}}
            >
              ${0===i.length?B`<mwc-list-item value="" disabled>Define tiers above first</mwc-list-item>`:i.map(e=>B`<mwc-list-item value=${e}>${e}</mwc-list-item>`)}
            </ha-select>
    ...
    `}_renderProfileRow(e,t){return B`
      <div class="profile-row">
        ...
        <ha-select
          label="Output type"
          .value=${e.type}
          @selected=${i=>this._updateProfile(t,{...e,type:i.detail.value})}
        >
        ...
        <ha-select
          ...
          @selected=${i=>this._updateProfile(t,{...e,viewing_distance:i.detail.value})}
        >
  ...
  `}};e([pe()],Te.prototype,"_config",void 0),e([pe()],Te.prototype,"_expandedEntity",void 0),e([pe()],Te.prototype,"_hass",void 0),Te=e([ce("display-solver-card-editor")],Te);var He=Object.freeze({__proto__:null,get DisplaySolverCardEditor(){return Te}});export{Re as DisplaySolverCard};
