 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function pe(e){return function(e){return(t,i)=>"object"==typeof i?de(e,t,i):((e,t,i)=>{const o=t.hasOwnProperty(i);return t.constructor.createProperty(i,e),o?Object.getOwnPropertyDescriptor(t,i):void 0})(e,t,i)}({...e,state:!0,attribute:!1})}const ue="?",fe={"mdi:molecule-co2":"co2","mdi:pool":"pool","mdi:thermometer":"thermostat","mdi:water":"water_drop","mdi:car-electric":"electric_car","mdi:fan":"mode_fan","mdi:lightbulb":"lightbulb","mdi:lock":"lock","mdi:door":"door_open","mdi:garage":"garage","mdi:garage-open":"door_open","mdi:garage-open-variant":"door_open","mdi:garage-variant":"garage","mdi:garage-lock":"lock","mdi:security":"security","mdi:air-filter":"air","mdi:factory":"factory","mdi:grill":"outdoor_grill","mdi:thermometer-auto":"device_thermostat","mdi:arrow-up":"arrow_upward","mdi:arrow-down":"arrow_downward","mdi:check-circle":"check_circle","mdi:chef-hat":"kitchen","mdi:smoke-detector":"detector_smoke","mdi:motion-sensor":"motion_sensor_active","mdi:window-open":"window","mdi:door-open":"door_open","mdi:fire":"local_fire_department","mdi:alarm":"alarm","mdi:bell":"notifications","mdi:home":"home","mdi:weather-sunny":"sunny","mdi:weather-rainy":"rainy","mdi:weather-snowy":"ac_unit","mdi:weather-cloudy":"cloud","mdi:weather-windy":"air","mdi:lightning-bolt":"bolt","mdi:power-plug":"power","mdi:battery":"battery_full","mdi:battery-low":"battery_1_bar","mdi:wifi":"wifi","mdi:wifi-off":"wifi_off","mdi:bluetooth":"bluetooth","mdi:volume-high":"volume_up","mdi:volume-off":"volume_off","mdi:play":"play_arrow","mdi:pause":"pause","mdi:stop":"stop","mdi:camera":"camera_alt","mdi:video":"videocam","mdi:microphone":"mic","mdi:speaker":"speaker","mdi:television":"tv","mdi:phone":"call","mdi:message":"message","mdi:email":"email","mdi:calendar":"calendar_today","mdi:clock":"schedule","mdi:map-marker":"location_on","mdi:car":"directions_car","mdi:bus":"directions_bus","mdi:train":"train","mdi:walk":"directions_walk","mdi:run":"directions_run","mdi:bicycle":"directions_bike","mdi:alert":"warning","mdi:alert-circle":"error","mdi:information":"info","mdi:help-circle":"help","mdi:star":"star","mdi:heart":"favorite","mdi:trash-can":"delete","mdi:pencil":"edit","mdi:magnify":"search","mdi:close":"close","mdi:plus":"add","mdi:minus":"remove","mdi:refresh":"refresh","mdi:download":"download","mdi:upload":"upload","mdi:share":"share","mdi:cog":"settings","mdi:account":"person","mdi:account-group":"group","mdi:shield":"shield","mdi:key":"key","mdi:window":"window","mdi:power":"power_settings_new","mdi:shield-lock":"lock","mdi:shield-home":"home","mdi:lightbulb-on":"lightbulb","mdi:lightbulb-off":"lightbulb","mdi:lightbulb-group":"lightbulb","mdi:lightbulb-group-off":"lightbulb","mdi:ceiling-light":"lightbulb","mdi:ceiling-light-multiple":"lightbulb","mdi:floor-lamp":"lightbulb","mdi:desk-lamp":"lightbulb","mdi:lamp":"lightbulb","mdi:string-lights":"lightbulb","mdi:led-strip":"lightbulb","mdi:led-strip-variant":"lightbulb","mdi:led-on":"lightbulb","mdi:blinds":"window","mdi:blinds-open":"window","mdi:curtains":"window","mdi:curtains-closed":"window","mdi:window-closed":"window","mdi:window-closed-variant":"window","mdi:window-open-variant":"window","mdi:roller-shade":"window","mdi:roller-shade-closed":"window","mdi:window-shutter":"window","mdi:window-shutter-open":"window","mdi:gate":"garage","mdi:gate-open":"garage","mdi:door-closed":"door_open","mdi:lock-open":"lock","mdi:lock-open-variant":"lock","mdi:motion-sensor-off":"motion_sensor_active","mdi:smoke-detector-off":"detector_smoke","mdi:smoke-detector-variant":"detector_smoke","mdi:water-off":"water_drop"},ge={garage:"",door_open:"",lock:"",security:"",co2:"",air:"",factory:"",mode_fan_off:"",mode_fan:"",power_settings_new:"",thermostat:"",water_drop:"",outdoor_grill:"",pool:"",device_thermostat:"",lightbulb:"",arrow_upward:"",arrow_downward:"",check_circle:"",kitchen:"",electric_car:"",detector_smoke:"",motion_sensor_active:"",window:"",local_fire_department:"",alarm:"",notifications:"",home:"",sunny:"",rainy:"",ac_unit:"",cloud:"",bolt:"",power:"",battery_full:"",battery_1_bar:"",wifi:"",wifi_off:"",bluetooth:"",volume_up:"",volume_off:"",play_arrow:"",pause:"",stop:"",camera_alt:"",videocam:"",mic:"",speaker:"",tv:"",call:"",message:"",email:"",calendar_today:"",schedule:"",location_on:"",directions_car:"",directions_bus:"",train:"",directions_walk:"",directions_run:"",directions_bike:"",warning:"",error:"",info:"",help:"",star:"",favorite:"",delete:"",edit:"",search:"",close:"",add:"",remove:"",refresh:"",download:"",upload:"",share:"",settings:"",person:"",group:"",shield:"",key:""};function _e(e){if(!e)return ue;if("entity"===e)throw new Error('resolveGlyphForCanvas: "entity" must be resolved to a concrete name before calling');if(e.startsWith("mdi:")){const t=fe[e];return void 0===t?(console.warn(`resolveGlyphForCanvas: no MDI→MSS mapping for "${e}" — add it to MDI_TO_MSS or use a Material Symbols Sharp name directly`),ue):t}return 1===e.length&&(e.codePointAt(0)??0)>127||2===e.length&&e.codePointAt(0),e}function me(e){if(0===e.length)return ue;if("entity"===e)throw new Error('resolveGlyph: "entity" must be resolved to a concrete name before calling resolveGlyph');if(e.startsWith("mdi:")){const t=fe[e];if(void 0===t)return console.warn(`resolveGlyph: no MDI→MSS mapping for "${e}" — add the icon to MDI_TO_MSS or use a Material Symbols Sharp name directly`),ue;const i=ge[t];return i||(console.warn(`resolveGlyph: MDI "${e}" maps to MSS "${t}" but "${t}" is not in MSS_CODEPOINTS — add "${t}" to your ESPHome firmware's font_glyphs list`),ue)}if(1===e.length){const t=e.codePointAt(0);if(void 0!==t&&t>127)return e}if(2===e.length){const t=e.codePointAt(0);if(void 0!==t&&t>65535)return e}const t=ge[e];return t||(console.warn(`resolveGlyph: glyph "${e}" not found in MSS_CODEPOINTS — add "${e}" to your ESPHome firmware's font_glyphs list`),ue)}function ye(e,t){const i=t?.attributes?.icon;if(i)return i;const o=t?.attributes?.device_class;return function(e,t){switch(e.split(".")[0]){case"light":return"lightbulb";case"cover":switch(t){case"garage":case"gate":return"garage";case"door":return"door_open";default:return"window"}case"binary_sensor":switch(t){case"battery":return"battery_full";case"carbon_monoxide":case"gas":case"smoke":return"detector_smoke";case"cold":return"ac_unit";case"connectivity":return"wifi";case"door":case"opening":return"door_open";case"garage_door":return"garage";case"heat":return"local_fire_department";case"light":return"sunny";case"lock":return"lock";case"moisture":return"water_drop";case"motion":case"moving":return"motion_sensor_active";case"occupancy":case"presence":return"home";case"plug":return"power";case"problem":return"error";case"running":return"play_arrow";case"safety":case"tamper":return"shield";case"sound":return"volume_up";case"window":return"window";default:return"info"}case"switch":return"power";case"lock":return"lock";case"alarm_control_panel":return"security";case"climate":return"thermostat";case"media_player":return"tv";case"fan":return"mode_fan";case"sensor":switch(t){case"temperature":return"thermostat";case"humidity":return"water_drop";case"co2":return"co2";case"pm25":case"pm10":return"air";default:return"info"}default:return"info"}}(e,o)}function be(e){const[t,i]=e.split(":").map(Number);return 60*t+i}function ve(e,t,i,o){if(void 0!==e.state&&t!==e.state)return!1;if(void 0!==e.range){const i=parseFloat(t);if(isNaN(i))return!1;const[o,s]=e.range;if(null!==o&&i<o)return!1;if(null!==s&&i>s)return!1}if(void 0!==e.above){const i=parseFloat(t);if(isNaN(i)||i<=e.above)return!1}if(void 0!==e.time_range){const[t,i]=e.time_range;if(!function(e,t,i){const o=60*i.getHours()+i.getMinutes(),s=be(e),n=be(t);return s<=n?o>=s&&o<=n:o>=s||o<=n}(t,i,o))return!1}if(void 0!==e.also)for(const t of e.also){const e=i[t.entity];if(!e||e.state!==t.state)return!1}return!0}function we(e,t,i,o,s=new Date){if(0===i.length)return null;const n=t[e.entity_id],r=n?.state;if(!n||"unavailable"===r||"unknown"===r){const t=e.rules?.some(e=>"unavailable"===e.when.state||"unknown"===e.when.state)??!1;if(!t){if(!o.unavailable_action||"hide"===o.unavailable_action)return null;const t="entity"===e.glyph?ye(e.entity_id,n):e.glyph??"";return{entityConfig:e,tier:i[i.length-1],color:"",glyphName:t,showInfo:o.show_info??!1,focusMode:!1,indicatorOnly:!1,driveZoneIndicator:!1}}}const a=r??"",l="entity"===e.glyph?ye(e.entity_id,n):e.glyph??"";return e.rules?function(e,t,i,o,s,n,r){if(!e.rules)return null;for(const a of e.rules){if(!ve(a.when,t,i,r))continue;const l=a.then;return"hide"===l.action?null:{entityConfig:e,tier:l.tier??o[0],color:l.color??"",glyphName:s,showInfo:l.show_info??n.show_info??!1,focusMode:l.focus_mode??!1,indicatorOnly:"indicator"===l.action,driveZoneIndicator:"show"===l.action&&!0===l.indicator}}return null}(e,a,t,i,l,o,s):e.thresholds?function(e,t,i,o,s){if(!e.thresholds)return null;const n=parseFloat(t);if(isNaN(n))return null;const r=e.color_scale??s.color_scale??[];let a=null,l=-1;for(let t=0;t<e.thresholds.length;t++){const i=e.thresholds[t];n>i.above&&(a=i,l=t)}if(!a)return null;const c=a.color??(l<r.length?r[l]:"");return{entityConfig:e,tier:a.tier??i[0],color:c,glyphName:o,showInfo:s.show_info??!1,focusMode:!1,indicatorOnly:!1,driveZoneIndicator:!1}}(e,a,i,l,o):null}const $e={red:{r:255,g:0,b:0},orange:{r:255,g:165,b:0},yellow:{r:255,g:255,b:0},green:{r:0,g:255,b:0},blue:{r:0,g:0,b:255},purple:{r:128,g:0,b:128},white:{r:255,g:255,b:255},cyan:{r:0,g:255,b:255},magenta:{r:255,g:0,b:255},black:{r:0,g:0,b:0}},xe=new Set;function Se(e){const t=$e[e];return void 0!==t?t:(xe.has(e)||(xe.add(e),console.warn(`resolveColor: unknown color "${e}" — valid values are: red, orange, yellow, green, blue, purple, white, cyan, magenta, black`)),{r:255,g:255,b:255})}const Ae={far:{skip_largest:0,max_info_rows:4,prefer_fewer_icons:!0,prefer_dense:!1,size_scale:2},near:{skip_largest:1,max_info_rows:4,prefer_fewer_icons:!1,prefer_dense:!1,size_scale:1},close:{skip_largest:0,max_info_rows:6,prefer_fewer_icons:!1,prefer_dense:!0,size_scale:.5}};function Ee(e){const t=Ae[e.viewing_distance];return void 0===t?(console.warn(`expandViewingDistance: unknown viewing_distance "${e.viewing_distance}" — falling back to "near"`),Ae.near):t}function ke(e,t){if(e.burn_in_drift){return{xOffset:Math.floor(t.getHours()/23*e.margin_px[0]),yOffset:Math.floor(t.getMinutes()/59*e.margin_px[1])}}return{xOffset:0,yOffset:0}}function Pe(e,t){const i=t.margin_px[0]/t.screen_px[0],o=t.margin_px[1]/t.screen_px[1];if("object"==typeof e)return e;switch(e){case"top-edge":return{x:0,y:0,w:1,h:o};case"bottom-edge":return{x:0,y:1-o,w:1,h:o};case"left-edge":return{x:0,y:0,w:i,h:1};case"right-edge":return{x:1-i,y:0,w:i,h:1};case"top-left":return{x:0,y:0,w:i,h:o};case"top-right":return{x:1-i,y:0,w:i,h:o};case"bottom-left":return{x:0,y:1-o,w:i,h:o};case"bottom-right":return{x:1-i,y:1-o,w:i,h:o}}}function Me(e,t){return{x:Math.floor(e.x*t.screen_px[0]),y:Math.floor(e.y*t.screen_px[1]),w:Math.round(e.w*t.screen_px[0]),h:Math.round(e.h*t.screen_px[1])}}function Ce(e,t,i,o){const s=e.severity_bar;if(!s)return null;const[n,r]=e.screen_px,[a,l]=e.margin_px,c=new Date,{xOffset:h,yOffset:d}=ke(e,c);let p,u;if(0===t.length){if(!1!==s.hide_when_idle)return null;p=0,u="entity"===s.color?{r:255,g:255,b:255}:Se(s.color)}else{const e=i.length,o=t[0].tier;p=(e-i.indexOf(o))/e,u="entity"===s.color?Se(t[0].color):Se(s.color)}const f=s.thickness_px,g=s.edge;let _,m,y,b;return"bottom"===g?(y=Math.round(p*(n-2*a)),b=f,_=a+h,m=r-l-f+d):"top"===g?(y=Math.round(p*(n-2*a)),b=f,_=a+h,m=l+d):"left"===g?(y=f,b=Math.round(p*(r-2*l)),_=a+h,m=l+d):(y=f,b=Math.round(p*(r-2*l)),_=n-a-f+h,m=l+d),{x:_,y:m,w:y,h:b,r:u.r,g:u.g,b:u.b}}function Oe(e,t){return function(e,t){const i=t[e.entity_id],o=i?.state??"",s=i?.attributes?.unit_of_measurement??"",n=(e.value_format??"{value} {unit}").replace(/\{value:\.0f\}/g,()=>{const e=parseFloat(o);return isNaN(e)?o:Math.round(e).toString()}).replace(/\{value\}/g,o).replace(/\{unit\}/g,s),r=e.label??i?.attributes?.friendly_name??e.id;return`${n.trim()} ${r}`.trimEnd()}(e,t)}function ze(e,t,i,o){const s=Object.keys(e.glyph_sizes).reduce((t,i)=>{const o=e.glyph_sizes[i].px;return o>t?o:t},0),n=Math.floor((e.screen_px[0]-s)/2),r=Math.floor((e.screen_px[1]-s)/2),a=t(e.idle_glyph),{r:l,g:c,b:h}=Se("white");return{codepoint:a,x:n,y:r,sizePx:s,r:l,g:c,b:h}}function je(e,t,i,o,s,n,r,a,l){const c=[],h=new Date,d=[];for(const s of e){const e=we(s,t,i,o,h);null!==e&&d.push(e);const n=Array.isArray(s.rules)&&s.rules.length>0,r=Array.isArray(s.thresholds)&&s.thresholds.length>0;n||r||c.push(`Entity '${s.id}' has no rules or thresholds and will never be active.`)}d.sort((e,t)=>i.indexOf(e.tier)-i.indexOf(t.tier));const p=function(e,t){return e.some(e=>e.focusMode)?e.filter(e=>e.tier===t[0]):e}(d,i);if(0===p.length){const{xOffset:e,yOffset:t}=ke(n,h),o=Object.keys(n.glyph_sizes)[0]??"small";return{profile_id:n.id,glyphs:[ze(n,r)],info:[],zones:[],severity_bar:Ce(n,[],i),layout:{icon:{min:0,max:1,size:o,cols:1},info:{min:0,max:0}},error:!1,warnings:c,page_count:1}}const u=new Map;for(const e of p)if(!u.has(e.glyphName)){const t=r(e.glyphName);if(u.set(e.glyphName,t),n.font_glyphs&&n.font_glyphs.length>0){const t=e.glyphName;n.font_glyphs.includes(t)||c.push(`Glyph '${t}' not in profile '${n.id}' font_glyphs — will render blank. Add '${t}' to the glyphs: list in your ESPHome device YAML and recompile.`)}}const f=new Map(s.map(e=>[e.id,e])),g=p.filter(e=>!e.indicatorOnly),_=new Map;for(const e of g){const t=e.entityConfig.group;if(void 0!==t){const i=f.get(t);i&&"overlay"===i.collapse&&!_.has(t)&&_.set(t,e)}}const m=new Set;let y=0;for(const e of g){const t=e.entityConfig.group;if(void 0!==t){const e=f.get(t);if(e&&"overlay"===e.collapse){m.has(t)||(m.add(t),y+=1);continue}}y+=1}const b=y,v=p.some(e=>e.showInfo),w=function(e,t,i){const o=Ee(e),s=Object.keys(e.glyph_sizes),n=Math.min(o.skip_largest,s.length-1),r=o.prefer_dense?[...e.layouts].reverse():e.layouts;for(const e of r){const o=s.indexOf(e.icon.size);if(!(-1!==o&&o<n)&&!(t<e.icon.min||t>e.icon.max)&&(i||!(e.info.min>0)))return e}return null}(n,b,v);if(null===w){const e=Object.keys(n.glyph_sizes),t={icon:{min:0,max:0,size:e[e.length-1]??"medium",cols:1},info:{min:0,max:0}};return{profile_id:n.id,glyphs:[],info:[],zones:[],severity_bar:null,layout:t,error:!0,errorReason:`No layout matches: icon_count=${b}, hasInfo=${v}. Check your profile's layouts table.`,warnings:c,page_count:1}}const $=Math.ceil(b/w.icon.max)||1,x=Math.min(a,$-1),S=[],A=new Set;for(const e of g){const t=e.entityConfig.group;if(void 0!==t){const e=f.get(t);if(e&&"overlay"===e.collapse){A.has(t)||(A.add(t),S.push(_.get(t)));continue}}S.push(e)}const E=x*w.icon.max,k=E+w.icon.max,P=S.slice(E,k),M=function(e,t,i){const o=new Date,{xOffset:s,yOffset:n}=ke(e,o),r=e.margin_px[0]+s,a=e.margin_px[1]+n,l=e.glyph_sizes[t.icon.size];if(void 0===l)throw new Error(`layout.icon.size "${t.icon.size}" is not defined in profile "${e.id}" glyph_sizes`);const c=l.px,h=Ee(e),d=new Set(e.layouts.map(e=>e.icon.size)),p=d.size<=1?h.size_scale:1,u=Math.max(8,Math.round(c*p)),f=t.icon.cols,g=i.filter(e=>!e.indicatorOnly);let _=0,m=0;return g.map(e=>{let t,i;e.showInfo?(m>0&&(_+=1,m=0),t=_,i=0,_+=1,m=0):(t=_,i=m,m+=1,m>=f&&(m=0,_+=1));const o=Math.floor(r+i*u),s=Math.floor(a+t*u),{r:n,g:l,b:c}=Se(e.color);return{codepoint:"",x:o,y:s,sizePx:u,r:n,g:l,b:c}})}(n,w,P),C=M.map((e,t)=>({...e,codepoint:u.get(P[t].glyphName)??""})),O=[];for(let e=0;e<P.length;e++){const i=P[e];if(!i.showInfo)continue;const o=C[e],s=Oe(i.entityConfig,t),{r:n,g:r,b:a}=Se(i.color);O.push({text:s,x:o.x+o.sizePx+8,y:o.y+Math.floor(o.sizePx/2)+5,r:n,g:r,b:a})}const{xOffset:z,yOffset:j}=ke(n,h),N=function(e,t){const i=[];for(const o of e.zones??[]){const s=t.find(e=>e.entityConfig.zone===o.id&&(!0===e.indicatorOnly||!0===e.driveZoneIndicator));if(!s)continue;const n=Me(Pe(o.position,e),e),{r,g:a,b:l}=Se(s.color);i.push({zoneId:o.id,x:n.x,y:n.y,w:n.w,h:n.h,r,g:a,b:l,shape:"filled_rectangle"})}return i}(n,p),R=Ce(n,p,i);return{profile_id:n.id,glyphs:C,info:O,zones:N,severity_bar:R,layout:w,error:!1,warnings:c,page_count:$}}function Ne(e,t){const i=[],o=[],s=[],n=[],r=[],a=[];for(let t=0;t<e.glyphs.length;t++){const l=e.glyphs[t];if(i.push(l.x),o.push(l.y),s.push(l.r),n.push(l.g),r.push(l.b),a.push(l.codepoint),i.length!==t+1||o.length!==t+1||s.length!==t+1||n.length!==t+1||r.length!==t+1||a.length!==t+1)throw new Error(`Glyph array length mismatch at index ${t}`)}const l=function(e,t){const i=Object.entries(e.glyph_sizes).sort((e,t)=>t[1].px-e[1].px).map(([e])=>e),o=i.indexOf(t);return-1===o?(console.warn(`glyphFontIndex: size name "${t}" not found in profile "${e.id}"; defaulting to index 0`),0):o}(t,e.layout.icon.size),c=[],h=[],d=[],p=[],u=[],f=[],g=[],_=[],m=[],y=[],b=[],v=[];for(let t=0;t<e.info.length;t++){const i=e.info[t];if(c.push(0),h.push(i.x),d.push(i.y),p.push(i.r),u.push(i.g),f.push(i.b),c.length!==t+1||h.length!==t+1||d.length!==t+1||p.length!==t+1||u.length!==t+1||f.length!==t+1)throw new Error(`Info glyph array length mismatch at index ${t}`);if(g.push(i.text),_.push(i.x),m.push(i.y),y.push(i.r),b.push(i.g),v.push(i.b),g.length!==t+1||_.length!==t+1||m.length!==t+1||y.length!==t+1||b.length!==t+1||v.length!==t+1)throw new Error(`Info text array length mismatch at index ${t}`)}const w=e.info.length>e.layout.info.max,$={filled_rectangle:0,circle:1,filled_circle:2},x=[],S=[],A=[],E=[],k=[],P=[],M=[],C=[];for(let t=0;t<e.zones.length;t++){const i=e.zones[t],o=$[i.shape];if(void 0===o&&console.warn(`packESPhomePayload: unknown shape '${i.shape}' for zone '${i.zoneId}' — defaulting to 0 (filled_rectangle)`),x.push(o??0),S.push(i.x),A.push(i.y),E.push(i.w),k.push(i.h),P.push(i.r),M.push(i.g),C.push(i.b),x.length!==t+1||S.length!==t+1||A.length!==t+1||E.length!==t+1||k.length!==t+1||P.length!==t+1||M.length!==t+1||C.length!==t+1)throw new Error(`Shape array length mismatch at index ${t}`)}if(null!==e.severity_bar){const t=e.severity_bar,i=x.length;if(x.push(0),S.push(t.x),A.push(t.y),E.push(t.w),k.push(t.h),P.push(t.r),M.push(t.g),C.push(t.b),x.length!==i+1||S.length!==i+1||A.length!==i+1||E.length!==i+1||k.length!==i+1||P.length!==i+1||M.length!==i+1||C.length!==i+1)throw new Error(`Shape array length mismatch at severity_bar index ${i}`)}const O=a.map(e=>e.codePointAt(0)??0);return{x:i.join(","),y:o.join(","),r:s.join(","),g:n.join(","),b:r.join(","),glyph:O.join(","),glyph_font:l,info_glyph:c.join(","),info_glyph_y:d.join(","),info_glyph_x:h.join(","),info_glyph_r:p.join(","),info_glyph_g:u.join(","),info_glyph_b:f.join(","),info_text:g.join("|"),info_text_y:m.join(","),info_text_x:_.join(","),info_text_r:y.join(","),info_text_g:b.join(","),info_text_b:v.join(","),info_scroll:w,draw_shape:x.join(","),draw_shape_x:S.join(","),draw_shape_y:A.join(","),draw_shape_d2:E.join(","),draw_shape_d3:k.join(","),draw_shape_r:P.join(","),draw_shape_g:M.join(","),draw_shape_b:C.join(","),error:e.error}}const Re=new Set;async function Ie(e,t,i){i.width=t.screen_px[0],i.height=t.screen_px[1];const o=i.getContext("2d");null!==o&&(o.fillStyle="#000",o.fillRect(0,0,i.width,i.height),await async function(e){if("undefined"!=typeof document&&document.fonts)for(const[,t]of Object.entries(e)){const e=t.px,i="Material Symbols Sharp",o=`${i}:${e}`;if(Re.has(o))continue;const s=`mss-font-${e}`;if(!document.getElementById(s)&&document.head){const t=document.createElement("link");t.id=s,t.rel="stylesheet",t.href=`https://fonts.googleapis.com/css2?family=Material+Symbols+Sharp:opsz,wght,FILL,GRAD@${e},400,0,0`,document.head.appendChild(t)}await document.fonts.load(`${e}px '${i}'`),Re.add(o)}}(t.glyph_sizes),function(e,t){for(const i of t){const t=i.codepoint===ue?"Material Design Icons":"Material Symbols Sharp";e.font=`${i.sizePx}px '${t}'`,e.fillStyle=`rgb(${i.r}, ${i.g}, ${i.b})`,e.fillText(i.codepoint,i.x,i.y+i.sizePx)}}(o,e.glyphs),function(e,t){for(const i of t)e.font="12px monospace",e.fillStyle=`rgb(${i.r}, ${i.g}, ${i.b})`,e.fillText(i.text,i.x,i.y)}(o,e.info),function(e,t){for(const i of t)"filled_rectangle"===i.shape?(e.fillStyle=`rgb(${i.r},${i.g},${i.b})`,e.fillRect(i.x,i.y,i.w,i.h)):"filled_circle"===i.shape?(e.fillStyle=`rgb(${i.r},${i.g},${i.b})`,e.beginPath(),e.arc(i.x+i.w/2,i.y+i.h/2,i.w/2,0,2*Math.PI),e.fill()):"circle"===i.shape&&(e.strokeStyle=`rgb(${i.r},${i.g},${i.b})`,e.beginPath(),e.arc(i.x+i.w/2,i.y+i.h/2,i.w/2,0,2*Math.PI),e.stroke())}(o,e.zones),function(e,t,i){if(null!==t)return e.fillStyle=`rgb(${t.r}, ${t.g}, ${t.b})`,void e.fillRect(t.x,t.y,t.w,t.h);if(!1===i.severity_bar?.hide_when_idle){e.strokeStyle="#555555";const t=i.margin_px,o=i.screen_px,s=i.severity_bar.thickness_px;e.strokeRect(t[0],o[1]-t[1]-s,o[0]-2*t[0],s)}}(o,e.severity_bar,t))}let Te=class extends ae{constructor(){super(...arguments),this._errors=[],this._results=new Map,this._pageState={}}setConfig(e){const t=function(e){const t=[];if("object"!=typeof e||null===e)t.push("config must be an object");else{const i=e,o=i.tiers,s=new Set;if(Array.isArray(o)&&0!==o.length)for(let e=0;e<o.length;e++)"string"!=typeof o[e]?t.push(`tiers[${e}] must be a string`):s.add(o[e]);else t.push("tiers must be a non-empty array");const n=i.entities;if(Array.isArray(n)&&0!==n.length){const e=new Set,o=i.groups;if(Array.isArray(o))for(const t of o)if("object"==typeof t&&null!==t){const i=t.id;"string"==typeof i&&e.add(i)}for(let i=0;i<n.length;i++){const o=n[i];if("object"!=typeof o||null===o){t.push(`entities[${i}] must be an object`);continue}const r=o;"string"==typeof r.id&&0!==r.id.length||t.push(`entities[${i}].id is required`),"string"==typeof r.entity_id&&0!==r.entity_id.length||t.push(`entities[${i}].entity_id is required`);const a=Array.isArray(r.rules),l=Array.isArray(r.thresholds);if(a&&l&&t.push(`entities[${i}] (id=${String(r.id)}) must not have both rules and thresholds`),a){const e=r.rules;for(let o=0;o<e.length;o++){const n=e[o];if("object"!=typeof n||null===n)continue;const r=n.then;if("object"==typeof r&&null!==r){const e=r.tier;void 0===e||"string"!=typeof e||s.has(e)||t.push(`entities[${i}].rules[${o}].then.tier "${e}" is not declared in tiers`)}}}if(l){const e=r.thresholds;let o=null;for(let n=0;n<e.length;n++){const r=e[n];if("object"!=typeof r||null===r)continue;const a=r,l=a.tier;void 0===l||"string"!=typeof l||s.has(l)||t.push(`entities[${i}].thresholds[${n}].tier "${l}" is not declared in tiers`);const c=a.above;"number"==typeof c&&(null!==o&&c<=o&&t.push(`entities[${i}].thresholds[${n}].above (${c}) must be strictly greater than previous (${o})`),o=c)}}"string"!=typeof r.group||e.has(r.group)||t.push(`entities[${i}].group "${String(r.group)}" references undeclared group`)}}else t.push("entities must be a non-empty array");const r=i.display_profiles;if(Array.isArray(r)&&0!==r.length)for(let e=0;e<r.length;e++){const i=r[e];if("object"!=typeof i||null===i){t.push(`display_profiles[${e}] must be an object`);continue}const o=i;"string"==typeof o.id&&0!==o.id.length||t.push(`display_profiles[${e}].id is required`);const s=new Set(["esphome","canvas","cast","png_file"]);"string"==typeof o.type&&s.has(o.type)||t.push(`display_profiles[${e}].type must be one of: esphome, canvas, cast, png_file`);const n=o.screen_px;if(Array.isArray(o.screen_px)&&2===o.screen_px.length&&"number"==typeof n[0]&&"number"==typeof n[1]||t.push(`display_profiles[${e}].screen_px must be a [width, height] tuple of numbers`),"esphome"===o.type&&("string"!=typeof o.service||0===o.service.length)){const i="string"==typeof o.id?` (id=${o.id})`:"";t.push(`display_profiles[${e}]${i} (type=esphome) must have a service field`)}}else t.push("display_profiles must be a non-empty array");const a=i.groups;if(Array.isArray(a)){const e=new Set;for(let i=0;i<a.length;i++){const o=a[i];if("object"!=typeof o||null===o)continue;const s=o.id;"string"==typeof s&&(e.has(s)&&t.push(`groups id "${s}" is not unique`),e.add(s))}}}return t}(e);t.length>0?this._errors=t:(this._config=structuredClone(e),this._errors=[],this._hass&&this._runSolver())}set hass(e){this._hass=e;for(const e of Object.keys(this._pageState))clearTimeout(this._pageState[e].dwellTimer);this._runSolver()}get hass(){return this._hass}_runSolver(){if(this._config&&this._hass)for(const e of this._config.display_profiles){this._pageState[e.id]??={currentPage:0};const t=this._pageState[e.id],i="canvas"===e.type?_e:me,o=je(this._config.entities,this._hass.states,this._config.tiers,this._config.defaults??{},this._config.groups??[],e,i,t.currentPage);if(this._results.set(e.id,o),"canvas"===e.type)this.requestUpdate();else if("esphome"===e.type&&!o.error){const t=e.service.split("."),i=t[0],s=t.slice(1).join("."),n=Ne(o,e);this._hass.callService(i,s,n).catch(e=>{console.error("display-solver: callService failed",e)})}if(o.page_count>1){const i=1e3*(e.page_dwell_s??5);t.dwellTimer=setTimeout(()=>{const t=this._pageState[e.id];t&&(t.currentPage=(t.currentPage+1)%o.page_count,this._runSolver())},i)}}}updated(e){if(super.updated(e),this._config)for(const e of this._config.display_profiles){if("canvas"!==e.type)continue;const t=this._results.get(e.id);if(!t)continue;const i=this.shadowRoot?.querySelector(`#canvas-${e.id}`);i&&Ie(t,e,i).catch(e=>{console.error("display-solver: renderToCanvas failed",e)})}}disconnectedCallback(){super.disconnectedCallback();for(const e of Object.keys(this._pageState))clearTimeout(this._pageState[e].dwellTimer)}render(){if(this._errors.length>0)return B`<ha-card>
        <div class="error">
  ...
  `}};e([pe()],Ue.prototype,"_config",void 0),e([pe()],Ue.prototype,"_expandedEntity",void 0),e([pe()],Ue.prototype,"_hass",void 0),Ue=e([ce("display-solver-card-editor")],Ue);var He=Object.freeze({__proto__:null,get DisplaySolverCardEditor(){return Ue}});export{Te as DisplaySolverCard};
